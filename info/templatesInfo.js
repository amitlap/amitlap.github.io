...
המתחם שיוקם יאפשר לכם להנות משירותי סיעוד, טיפול אישי ובריאותי, השגחה, נקיון, פעילויות חברתיות ופנאי. כמו כן, יסופקו בו שירותי פיקוח וסיוע 24 שעות ביממה המאפשרים מקסום של איכות חיי התושבים, אוטונומיה, פרטיות, עצמאות ובטיחות..</p>
    ...
    FentonFarmsGolfClub: {
      ...
      overview: `
        ...
        <p>
           מועדון הגולף פנטון פארמס, שנוסד ב-1939 משתרע על פני שטח של 6 ק״מ והוא מציע מסלולים נגישים למתחילים לצד מסלולים מאתגרים לשחקנים מנוסים יותר. במקום תמצאו גם מועדון המהווה מקום מפגש ואירוח עם פעילויות עבור בני הגיל השלישי. במהלך ימות השבוע, בין שני לחמישי, תוכלו להנות מהמתקנים בתעריפים מוזלים יותר. לפרטים נוספים, בקרו באתר
        </p>
      `,
      details: `
        <p>
