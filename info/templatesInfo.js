...
const tabsInfo = {
    ...
    LakeFenton: {
      header: `אגם פנטון`,
      overview: `
      סקירה כללית: אגם שמשתרע על פני 845 דונם ומציע מגוון פעילויות פנאי כמו שיט, דיג, או סתם מנוחה במקום רגוע ונעים. במרחק קצר מהפרויקט, תוכלו להנות מטבע שופע, לצאת להליכה פסטורלית או לשבת לפיקניק על שפת האגם.
