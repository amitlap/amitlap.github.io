...
const tabsInfo = {
    ...
    DaunerMartinNaturePreserve: {
      ...
      `,
      datails: `פירוט: שמורת הטבע דאונר-מרטין היא פנינת טבע ייחודית. תוכלו למצא בה שבילי הליכה שעוברים דרך יערות, איזורי ביצות ומרחבי דשא עצומים. אל המקום מגיעים מטיילים רבים שמבקשים לבלות יום רגוע בטבע, לתצפת על ציפורים, לצלם ולהתנתק מהעומס והלחץ היומיומי. במקום ישנם שבילים שמתוחזקים היטב והופכים את החוויה לנגישה, קלה ונוחה גם לבני הגיל השלישי. זו הזדמנות מצויינת לצאת להליכה בחיק הטבע, להפחית לחצים ולתרום לבריאות הלב והנפש.`
    },
    SevenLakesStatePark: {
