...
המתחם שיוקם יאפשר לכם להנות משירותי סיעוד, טיפול אישי ובריאותי, השגחה, נקיון, פעילויות חברתיות ופנאי. כמו כן, יסופקו בו שירותי פיקוח וסיוע 24 שעות ביממה המאפשרים מקסום של איכות חיי התושבים, אוטונומיה, פרטיות, עצמאות ובטיחות..</p>
    ...
    LakeFenton: {
      header: `אגם פנטון`,
      overview: `
      <p>סקירה כללית: אגם שמשתרע על פני 845 דונם ומציע מגוון פעילויות פנאי כמו שיט, דיג, או סתם מנוחה במקום רגוע ונעים. במרחק קצר מהפרויקט, תוכלו להנות מטבע שופע, לצאת להליכה פסטורלית או לשבת לפיקניק על שפת האגם.</p>
    ...
    DaunerMartinNaturePreserve: {
      ...
      overview: `
      <p>סקירה כללית: שמורת טבע שמשתרעת על פני 155 דונם ויש בה מסלולי הליכה נוחים ונגישים. חויה מושלמת לאוהבי טבע שרוצים קצת להתאורר מהעיר, וכל זה, במרחק קצר ממתחם המגורים.</p>
